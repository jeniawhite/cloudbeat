...
// regression test for the pagination bug reported against ~250/309 Azure subscriptions
// returning only subscription-level findings with zero resource-level findings
// (elastic/seceng#14395).
//
